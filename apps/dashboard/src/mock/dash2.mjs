  ...
  entry: {
    ...
    components: {
      ...
      _widget_1698745986649: {
        ...
        drilldown: 'pc',
        fields: [
          { name: '_widget_1698224709150', form: '6530f3223d93c67a5d654bfa', type: 'sn', title: '设备维修单编号', tag: 'f_1698744727704', width: 125 },
          ...
          { name: '_widget_1697710612223', form: '6530f3223d93c67a5d654bfa', type: 'textarea', title: '故障简述', tag: 'f_1698744727707', width: 214 },
      ...
      _widget_1698746129847: {
        ...
        drilldown: 'pc',
        fields: [
          { name: '_widget_1698224709150', form: '6530f3223d93c67a5d654bfa', type: 'sn', title: '设备维修单编号', tag: 'f_1698744727704', width: 131 },
          { name: '_widget_1697706787285', form: '6530f3223d93c67a5d654bfa', type: 'text', title: '设备编码', tag: 'f_1698744727705' },
          { name: '_widget_1697706787287', form: '6530f3223d93c67a5d654bfa', type: 'text', title: '设备名称', tag: 'f_1698744727706' },
        ...
        filter: {
          cond: [
            ...
            },
            {
              ...
              colorEnable: true,
              items: [
                { text: '已完成', value: '已完成', widgetsMap: ['_widget_1562687598930', '_widget_1563343045002', '_widget_1562687599003'], color: '#2FCD6E' },
      ...
      _widget_1698746267295: {
        ...
        drilldown: 'pc',
        fields: [
          { name: '_widget_1562655921428', form: '653a305726e518c959a737b4', type: 'sn', title: '设备保养单编号', tag: 'f_1698744727712', width: 144 },
          {
            name: '_widget_1562714937873',
            form: '653a305726e518c959a737b4',
            type: 'datetime',
      ...
      _widget_1699515323517: {
        ...
        metrics: [
          ...
          { tag: 'f_1699515365960', name: '_widget_1699514346847', form: '6540d34b9ecc527e89a520f2', type: 'number', title: '✅已检次数', op: 'sum' },
          { tag: 'f_1699515367298', name: '_widget_1699514313793', form: '6540d34b9ecc527e89a520f2', type: 'number', title: '⛔漏检次数', op: 'sum' }
        ],
        formulas: []
      },
      ...
      _widget_1700012547190: {
        ...
        yFields: [],
        metrics: [
          { tag: 'f_1700459421898', name: '_widget_1700015628157', form: '65362eec3761f7f4e9947577', type: 'sn', title: '设备数量', op: 'count', format: '' }
        ],
        formulas: []
      },
      _widget_1700012687107: {
        ...
        yFields: [],
        metrics: [
          { tag: 'f_1700478747300', name: '_widget_1700015628157', form: '65362eec3761f7f4e9947577', type: 'sn', title: '设备数量', op: 'count', format: '' }
        ],
        formulas: []
      },
      _widget_1700720745327: {
    ...
    updateTime: '2024-03-02T07:16:45.135Z',
